...
from jobs_ranker.cli import interactive
...
def main():
    ...
    task_chooser = interactive.TaskChooser(tasks_dao=TasksConfigsDao())
    ...
    labeling_loop = interactive.LabelingLoop(ranker=ranker)
